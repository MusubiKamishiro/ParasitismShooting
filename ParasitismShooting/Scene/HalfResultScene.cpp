...
void HalfResultScene::Draw(const bool& flag)
{
	...
	DxLib::DrawString(GetStringRightPosx("ContinueCount",	250), 320, "ContinueCount",	0x00ff00);
	DxLib::DrawString(GetStringRightPosx("Difficult",		250), 380, "Difficult",		0x00ff00);
	DxLib::DrawString(GetStringRightPosx("TotalBonus",		250), 450, "TotalBonus",	0x00ff00);

	for (int i = 0; i < 4; ++i)
	{
		DxLib::DrawString(270, 200 + i * 40, "*", 0x00ff00);
		DxLib::DrawString(370, 200 + i * 40, "=", 0x00ff00);
	}

	DxLib::DrawString(370, 380, "*", 0x00ff00);

	DxLib::DrawString(GetStringRightPosx("1000",	350), 200, "1000",	0x00ff00);
	DxLib::DrawString(GetStringRightPosx("10",		350), 240, "10",	0x00ff00);
	DxLib::DrawString(GetStringRightPosx("100",		350), 280, "100",	0x00ff00);
	DxLib::DrawString(GetStringRightPosx("-1000",	350), 320, "-1000",	0x00ff00);

	DxLib::DrawFormatString(400, 200, 0x00ff00, "%-8d", Score::Instance().stageBonus);
	DxLib::DrawFormatString(400, 240, 0x00ff00, "%-8d", Score::Instance().parasBonus);
	DxLib::DrawFormatString(400, 280, 0x00ff00, "%-8d", Score::Instance().bossHpBonus);
	DxLib::DrawFormatString(400, 320, 0x00ff00, "%-8d", Score::Instance().contBonus);
	DxLib::DrawFormatString(400, 380, 0x00ff00, "%-.1f", Score::Instance().diffBonus);
